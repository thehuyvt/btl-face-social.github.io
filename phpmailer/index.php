...
try {
    ...
    $mail->addAddress($data[10], $data[1]); // Add a recipient
    ...
    // Mail body content 
    $bodyContent = '<p>Thân gửi Tân sinh viên <b>'.$data[1].'</b></h1>'; 
    $bodyContent .= '<p>Trường Đại học Thủy lợi xin chúc mừng Em đã trở thành Tân sinh viên ngành <b>'.$data[7].'</b> của Khoa Công nghệ thông tin. </p>'; 
